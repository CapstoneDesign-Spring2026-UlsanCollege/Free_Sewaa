...
|-----------|--------------|-------------|----------|
| Backend API (routes, models) | Rampathak12 | Yes | [server/routes/](../../server/routes/), [server/models/](../../server/models/) |
| Frontend UI (pages, components) | Sujan Shrestha | Yes | [client/src/generated-pages/](../../client/src/generated-pages/), [html/](../../html/) |
| Testing & QA | Sujan Tamang | Yes | [docs/TESTING_PLAN.md](../../docs/TESTING_PLAN.md), checklists |
| Styling & CSS | Swornim Karki | Yes | [css/theme.css](../../css/theme.css), responsive design |
