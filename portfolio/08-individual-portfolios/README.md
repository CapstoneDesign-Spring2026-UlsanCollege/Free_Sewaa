...
| 5 | **Mohan Khadka** | Bug Fixes & Maintenance | [Bug Reports](../../docs/ISSUES/BUGS/) · [Project Board](../../docs/PROJECT/PROJECT_BOARD.md) · [QA Checklist](../../docs/QA_CHECKLIST.md) · [Testing Checklist](../../docs/QA/MANUAL_TESTING_CHECKLIST.md) | [View Portfolio](./Mohan_Khadka.md) |
