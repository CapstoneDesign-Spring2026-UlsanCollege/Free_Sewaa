...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Testing Strategy and Planning | Developed the overall testing approach including unit, integration, manual, accessibility, and regression testing. Created detailed test plans for authentication, item posting, and messaging features. | (../../../docs/TESTING_STRATEGY.md)                                |
