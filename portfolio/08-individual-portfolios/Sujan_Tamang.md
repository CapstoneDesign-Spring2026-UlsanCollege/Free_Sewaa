...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Testing Strategy and Planning | Developed the overall testing approach including unit, integration, manual, accessibility, and regression testing. Created detailed test plans for authentication, item posting, and messaging features. | `docs/TESTING_STRATEGY.md`, `docs/TESTING_PLAN.md`                                 |
| QA Checklists                 | Created manual testing checklists for authentication, browse, donate, requests, messaging, admin panel, mobile responsiveness, and form validation.                                                      | `MANUAL_TESTING_CHECKLIST.md`, `FORM_VALIDATION_CHECKLIST.md`                      |
