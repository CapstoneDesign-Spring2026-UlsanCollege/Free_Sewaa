# Sprint 02 — Core MVP Features Decision

## Sprint Goal
Define MVP scope and begin core feature implementation.

## What We Planned
- Decide between MVP options (A: marketplace vs B: donation platform)
- Start Browse Items page
- Design Post Item form
...
- Request flow — moved to Sprint 3

## Scope Changes
- Narrowed from full marketplace to focused donation platform
...
- Item detail modal
- Request and Contact Donor flow
