(function () {
  ...
  const TEXT = {
    en: {
      ...
      'Notifications': 'Notifications', 'Messages': 'Messages', 'Settings': 'Settings', 'My Posts': 'My Posts', 'Track Your Order': 'Track Your Order', 'Premium Plans': 'Premium Plans', 'Personal Information': 'Personal Information', 'Edit Profile': 'Edit Profile', 'Change Region': 'Change Region', 'Saved Items': 'Saved Items', 'My Requests': 'My Requests', 'Toggle Dark Mode': 'Toggle Dark Mode', 'Logout': 'Logout',
    ...
    ko: {
      ...
      'Notifications': '알림', 'Messages': '메시지', 'Settings': '설정', 'My Posts': '내 게시물', 'Track Your Order': '주문 확인', 'Premium Plans': '프리미엄', 'Personal Information': '개인 정보', 'Edit Profile': '프로필 수정', 'Change Region': '지역 변경', 'Saved Items': '저장한 항목', 'My Requests': '내 요청', 'Toggle Dark Mode': '다크 모드 전환', 'Logout': '로그아웃',
    ...
    ne: {
      ...
      'Notifications': 'सूचना', 'Messages': 'सन्देश', 'Settings': 'सेटिङ', 'My Posts': 'मेरा पोस्ट', 'Track Your Order': 'अर्डर हेर्नुहोस्', 'Premium Plans': 'प्रिमियम योजना', 'Personal Information': 'व्यक्तिगत जानकारी', 'Edit Profile': 'प्रोफाइल सम्पादन', 'Change Region': 'क्षेत्र बदल्नुहोस्', 'Saved Items': 'सुरक्षित सामान', 'My Requests': 'मेरा अनुरोध', 'Toggle Dark Mode': 'डार्क मोड बदल्नुहोस्', 'Logout': 'लगआउट',
    ...
    hi: {
      ...
      'Notifications': 'सूचनाएं', 'Messages': 'संदेश', 'Settings': 'सेटिंग्स', 'My Posts': 'मेरी पोस्ट', 'Track Your Order': 'ऑर्डर ट्रैक करें', 'Premium Plans': 'प्रीमियम प्लान', 'Personal Information': 'व्यक्तिगत जानकारी', 'Edit Profile': 'प्रोफाइल संपादित करें', 'Change Region': 'क्षेत्र बदलें', 'Saved Items': 'सेव किए गए आइटम', 'My Requests': 'मेरे अनुरोध', 'Toggle Dark Mode': 'डार्क मोड बदलें', 'Logout': 'लॉगआउट',
    ...
    fil: {
      ...
      'Notifications': 'Notifications', 'Messages': 'Messages', 'Settings': 'Settings', 'My Posts': 'Aking Posts', 'Track Your Order': 'I-track ang Order', 'Premium Plans': 'Premium Plans', 'Personal Information': 'Personal na Impormasyon', 'Edit Profile': 'I-edit ang Profile', 'Change Region': 'Palitan ang Rehiyon', 'Saved Items': 'Saved Items', 'My Requests': 'Aking Requests', 'Toggle Dark Mode': 'Palitan ang Dark Mode', 'Logout': 'Logout',
